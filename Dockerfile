...
RUN DEBIAN_FRONTEND=noninteractive apt-get -yqq install ssh fetchmail postfix amavisd-new clamav-daemon spamassassin razor pyzor slapd ldap-utils phpldapadmin
